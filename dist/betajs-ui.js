...
Scoped.define("module:Gestures.Gesture", [
    ...
    return ElementStateHost.extend({
        scoped: scoped
    }, function(inherited) {
        return {
        ...
        return {
            "Initial": {
                events: Objs.filter([{
                    ...
                    args: {
                        element: options.disable_scroll_element,
                        threshold: options.disable_scroll_time
                    },
